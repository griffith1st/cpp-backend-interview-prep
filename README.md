...
- 旧的三项目划分文档仍保留在 [历史版本](07-项目与工程/JavaGuide第一阶段-三项目职责划分.md)，仅用于追溯；当前简历的两项目口径、源码核对范围和限制见 [RMDB 与 ITMS-BD 最终版](07-项目与工程/项目边界-RMDB-ITMS-最终版.md) 及 [本次发布记录](90-来源与记录/2026-09-13-两项目边界发布记录.md)。合作模块归属是建议方案，源码事实与个人经历分别标记。
